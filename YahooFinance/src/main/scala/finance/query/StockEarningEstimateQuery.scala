...
object StockEarningEstimateQuery extends Database{
  ...
  def getStockEarningEstimate(stockEarningEstimate: StockEarningEstimate): Option[StockEarningEstimate] ={
    Util.printLog("getStockEarningEstimate, symbol=%s, est_date=%s, end_date=%s, period=%s".format(stockEarningEstimate.stock, stockEarningEstimate.est_date, stockEarningEstimate.end_date, stockEarningEstimate.period))
    sql"""
  ...
  def insertStockEarningEstimateQuery(stockEarningEstimate: StockEarningEstimate): Unit ={
    ...
    if(queryStockRec.isEmpty){
      Util.printLog("insertStockEarningEstimateQuery, symbol=%s, est_date=%s, end_date=%s, period=%s".format(stockEarningEstimate.stock, stockEarningEstimate.est_date, stockEarningEstimate.end_date, stockEarningEstimate.period))
      sql"""
  ...
  def updateStockEarningEstimateQuery(stockEarningEstimate: StockEarningEstimate): Unit ={
   ...
   SET est_avg=${stockEarningEstimate.est_avg}, est_high=${stockEarningEstimate.est_high},
      ...
      Util.printLog("updateStockEarningEstimateQuery, symbol=%s, est_date=%s, end_date=%s, period=%s est_avg=%s".format(stockEarningEstimate.stock, stockEarningEstimate.est_date, stockEarningEstimate.end_date, stockEarningEstimate.period, stockEarningEstimate.est_avg))
      sql"""
        UPDATE finance.stock_earning_estimate
